...
% Authors: Charalambous et al., 2020

clear all
close all

%-----------------------------------------------------------------------------------------------------------------------------------------------------%
% a. To obtain the operational aspect of the environmental SNR metric: (i) for the LF and BB the power is calculated for fmin = 0.2Hz and fmax = 0.5Hz% 
% (ii ) for the HF, VF and 2.4Hz events the power is taken at the 2.4Hz resonance, for which we use the bandwidth fmin = 2.2Hz and fmax = 2.6Hz.      %
%                                                                                                                                                     %
...
% adapted from Giardini et al., 2020.     
%-----------------------------------------------------------------------------------------------------------------------------------------------------%
