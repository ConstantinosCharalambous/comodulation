...
%                                                                         %
% This code produces the spectrograms shown in Figure 1. It also          %   
% demonstrates how the paper processes the data to obtain the             %
% spectrograms from which the paper builds upon by extracting power over  %
% various frequency bands. It can also be used to obtain the spectrograms % 
% of Figure 3, 4, 9, 10, 11 & 14.                                         %
% This code requires the removeLow.m function to run.                     %
%                                                                         %
